...
const experiences: { role: string; company: string; period: string; description: ReactNode; link: string | null; current: boolean }[] = [
  {
    ...
    description: <>Uno de mis mayores logros es la construcción el sistema web que permite la <strong>publicación de vuelos de la compañía</strong> y la integración que realiza la asignación del servicio Premium Economy en cada una de las rutas.</>,
    link: null,
    current: true,
  },
  {
